 ...
 */
package org.bud.framework.service.flow.idm;
...
import org.bud.framework.domain.flow.RemoteGroup;
import org.bud.framework.domain.flow.RemoteToken;
import org.bud.framework.domain.flow.RemoteUser;
...
//        adminPassword = environment.getRequiredProperty(PROPERTY_ADMIN_PASSWORD);
        url = "http://localhost:" + port + contextPath + "/app/admin/flow";
        adminUser = "";
        adminPassword = "";
    }
